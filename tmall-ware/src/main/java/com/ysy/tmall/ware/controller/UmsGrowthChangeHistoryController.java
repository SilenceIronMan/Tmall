...
import com.ysy.tmall.ware.service.UmsGrowthChangeHistoryService;
 ...
 */
@RestController
@RequestMapping("ware/umsgrowthchangehistory")
public class UmsGrowthChangeHistoryController {
     ...
     */
    @RequestMapping("/list")
    //@RequiresPermissions("ware:umsgrowthchangehistory:list")
    ...
    //@RequiresPermissions("ware:umsgrowthchangehistory:info")
     ...
     */
    @RequestMapping("/save")
    //@RequiresPermissions("ware:umsgrowthchangehistory:save")
    ...
    //@RequiresPermissions("ware:umsgrowthchangehistory:update")
    ...
    //@RequiresPermissions("ware:umsgrowthchangehistory:delete")
